...
This code is the supply code for optimization, generate objective, gradiant,
constrants, and Jac.
...
class CyclingModelOpt(object):
    
    
    def __init__(self, cy_theta, Nnode, nDoF, interval, lamda, Human_const, Exo_const, Bike_param):
        
        self.cy_theta = cy_theta
        self.Nnode = Nnode
        self.nDoF = nDoF
        self.interval = interval
        self.lamda = lamda
        self.Human_const = Human_const
        self.Exo_const = Exo_const
        self.Bike_param = Bike_param
    ...
    def dynamic_equations(self, q, qd, qdd, T_input):
        ...
        PM = VirtualPedalModel(self.Bike_param)
